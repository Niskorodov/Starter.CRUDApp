package ru.niskorodov.springcourse.dao;
...
public class PersonDAO {
    ...
    public void save(Person person) {
        jdbcTemplate.update("INSERT INTO Person(name,age,email, adress) VALUES( ?, ?, ?, ?)",
                ...
                person.getEmail(), person.getAdress());
    }

    public void update(int id, Person updatedPerson) {
        jdbcTemplate.update("UPDATE Person SET name=?, age=?, email=?, adress=? WHERE id=?", updatedPerson.getName(),
                updatedPerson.getAge(), updatedPerson.getEmail(),updatedPerson.getAdress(), id);
    }
    ...
    //////////////////////////////////////////////////
    /// Тестируем производительность пакетной всатвки
    //////////////////////////////////////////////////
